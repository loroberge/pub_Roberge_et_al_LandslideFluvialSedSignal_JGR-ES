# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 14:38:23 2024

@author: LaurentRoberge
"""

"""
Plot effects of different V values on landscape, Qs timeseries, 
...
figure_title = 'Net effective settling velocity'
scenarios = ['Low ($V$ = 0.1 $m/y$)',
             'Moderate ($V$ = 1 $m/y$)',
             'High ($V$ = 10 $m/y$)',
             ]
...
image_file_name = ['V_25-Vs-Km-1e3.png',
                   'V_25-Vm-Km-1e3.png',
                   'V_25-Vl-Km-1e3.png',
                   ]

timeseries_path = project_path + '\\Timeseries'
timeseries_file_name = 'Qs_timeseries_varying_Vs_cleaned.csv'

mtm_spectra_path = project_path + '\\Spectra'
mtm_norm_file_name = 'Qs_50m_varying_Vs_nw7_MTMnorm.csv'
mtm_mean_file_name = 'Qs_50m_varying_Vs_nw7_MTMmean.csv'
mtm_period_file_name = 'Qs_50m_varying_Vs_period.csv'

col_names = ['EQ_DA25_Square_Vs_tLS1e3_Ksedm',
             'EQ_DA25_Square_Vm_tLS1e3',
             'EQ_DA25_Square_Vl_tLS1e3_Ksedm',
             ]

TRW = [2200,3000,4700]
TWB = [20000,16000,19000]
...
for scenario in range(len(scenarios)):
    ...
    plt.text(-110,-75,text_row_1[scenario],fontsize=14)
