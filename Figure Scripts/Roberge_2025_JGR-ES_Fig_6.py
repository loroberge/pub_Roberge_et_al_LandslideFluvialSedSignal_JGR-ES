# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 14:14:34 2024

@author: LaurentRoberge
"""

"""
Plot effects of different Ks values on landscape, Qs timeseries, 
...
figure_title = 'Sediment erodibility'
scenarios = ['Low ($K_s$ = $5$x$10^{-5}$ $m^{-1}$)',
             'Moderate ($K_s$ = $1$x$10^{-4}$ $m^{-1}$)',
             'High ($K_s$ = $5$x$10^{-4}$ $m^{-1}$)',
             ]
...
image_file_name = ['Ks_25-Vm-Ks-1e3.png',
                   'Ks_25-Vm-Km-1e3.png',
                   'Ks_25-Vm-Kl-1e3.png',
                   ]

timeseries_path = project_path + '\\Timeseries'
timeseries_file_name = 'Qs_timeseries_varying_Ks_cleaned.csv'

mtm_spectra_path = project_path + '\\Spectra'
mtm_norm_file_name = 'Qs_50m_varying_Ks_nw7_MTMnorm.csv'
mtm_mean_file_name = 'Qs_50m_varying_Ks_nw7_MTMmean.csv'
mtm_period_file_name = 'Qs_50m_varying_Ks_period.csv'

col_names = ['EQ_DA25_Square_Vm_tLS1e3_Kseds',
             'EQ_DA25_Square_Vm_tLS1e3',
             'EQ_DA25_Square_Vm_tLS1e3_Ksedl',
             ]

TRW = [4500,3000,850]
TWB = [17000,16000,30000]
...
for scenario in range(len(scenarios)):
    ...
    plt.text(25,-70,text_row_1[scenario],fontsize=14)
    ...
    # plt.locator_params(axis='y', nbins=5)
    # plt.title(f'{scenarios[scenario]}')
    plt.text(start_time+6e4,12,text_row_2[scenario],fontsize=14)
