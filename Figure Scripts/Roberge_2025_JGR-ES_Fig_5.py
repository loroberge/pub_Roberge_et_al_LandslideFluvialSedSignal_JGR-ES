# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 13:26:02 2024

@author: LaurentRoberge
"""

"""
Plot effects of different tLS values on landscape, Qs timeseries, and Qs power
spectra for JGR:ES paper: Roberge et al., 2025.
"""
...
figure_title = 'Landslide frequency'
scenarios = ['High ($t_{LS}=1$x$10^3$)', 
             'Moderate ($t_{LS}=1$x$10^5$)', 
             'Low ($t_{LS}=1$x$10^7$)',
             ]
...
image_file_name = ['tLS_25-Vm-Km-1e3.png',
                   'tLS_25-Vm-Km-1e5.png',
                   'tLS_25-Vm-Km-1e7.png',
                   ]
...
col_names = ['EQ_DA25_Square_Vm_tLS1e3',
             'EQ_DA25_Square_Vm_tLS1e5',
             'EQ_DA25_Square_Vm_tLS1e7',
             ]

TRW = [3000,5500,40000]
TWB = [16000,50000,None]
...
start_time = 0
stop_time = 2e6
start_time_zoom = 15e6
stop_time_zoom = 15.02e6
...
for scenario in range(len(scenarios)):
    ...
    plt.text(100,-80,text_row_1[scenario],fontsize=14)
    ...
    # plt.locator_params(axis='y', nbins=5)
    # plt.title(f'{scenarios[scenario]}')
    plt.text(80,8,text_row_4[scenario],fontsize=14)
